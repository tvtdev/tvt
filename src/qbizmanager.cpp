	...
	/*	if (m_doge_balance_include.toDouble() >= 10000)
		{
			...
			if (m_doge_balance.toDouble() > m_doge_balance_include.toDouble()-10000-1500)
			{
		...
		//if (m_doge_balance_include.toDouble() >= 13000)
		//{
		//	yobit_make_trade("0.00001","15","sell","doge_eth");
		//}
